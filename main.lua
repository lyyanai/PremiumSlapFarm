...
Slap:AddToggle({
	Name = "Auto Slap Blink & Replica & Baller { TURN ME ON } 2",
	Default = false,
	Callback = function(Value)
slap = Value
if slap == true then
...
Slap:AddToggle({
	Name = "Auto Slap Blink & Replica & Baller { TURN ME ON } 3",
	Default = false,
	Callback = function(Value)
slap = Value
if slap == true then
...
Slap:AddToggle({
	Name = "Auto Slap Blink & Replica & Baller { TURN ME ON } 4",
	Default = false,
	Callback = function(Value)
slap = Value
if slap == true then
...
spawn(function()
				...
				game.ReplicatedStorage.Events.Boxing:FireServer(v:WaitForChild("HumanoidRootPart"), false)
end)
		end
end
task.wait(0)
...
Slap:AddToggle({
	Name = "Auto Slap Blink & Replica & Baller { TURN ME ON } 5",
	Default = false,
	Callback = function(Value)
slap = Value
if slap == true then
...
spawn(function()
				...
				game.ReplicatedStorage.Events.Boxing:FireServer("HumanoidRootPart", false)
end)
task.wait(0)
until slap == false
end
